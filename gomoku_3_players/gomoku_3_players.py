...
from gomoku_3_players.palette_wh import COLOR_BLACK, COLOR_WHITE, COLOR_BLUE, \
    COLOR_RED, COLOR_GRAY, COLOR_BOARD, COLOR_BUTTON, COLOR_AC_BUTTON, \
    W_H, P_WID, C_WID, P1_HT, P2_HT, P3_HT, P1_SC_HT, P2_SC_HT, P3_SC_HT, \
    P1_WIN_HT, P2_WIN_HT, P3_WIN_HT
...
class Gomoku:
    ...
    def interactive_button(self, x=45*16, y=45, w=125, h=45,
        ...
        pygame.draw.rect(self.screen, self.button_color, (self.x, W_H - 90, w, h))
        # Draw text on buttons.
        self.text_draw("NEW GAME", self.x + 59, self.y + 25, (200, 0, 0), 20)
        self.text_draw("NEXT GAME", self.x + 62, self.y + 95, (0, 0, 180), 20)
        self.text_draw("QUIT", self.x + 56, W_H - 65, (200, 0, 200), 20)
        ...
        # Quit.
        if self.w + self.x > mouse[0] > self.x and \
                W_H - 90 + self.h > mouse[1] > W_H - 90:
            pygame.draw.rect(self.screen, self.ac_button_color,
                             (self.x, W_H - 90, self.w, self.h))
            self.text_draw("Quit", self.x + 56, W_H - 65, (225, 0, 225), 20)
    ...
    def score(self, stone, color_name, player_score, play_order):
        ...
        if self.result:
            if self.color_name == "white":
                self.text_draw("WIN", P_WID, P1_WIN_HT, COLOR_GRAY, 45)

            elif self.color_name == "black":
                self.text_draw("WIN", P_WID, P2_WIN_HT, COLOR_BLACK, 45)

            elif self.color_name == "blue":
                self.text_draw("WIN", P_WID, P3_WIN_HT, COLOR_BLUE, 45)
